        ...
        <div class="card p-5 shadow-lg">
            ...
            //    $md5 = md5($d['ID_User']);
               ...
               echo"<div class='col-md-6 mb-2'>
                    ...
                    <a class='btn btn-warning btn-sm btn-icon-split' href='profil_peminjaman_edit.php'>
                        <span class='icon text-white-50'>
                        <i class='fas fa-cogs mt-1'></i>
                        </span>
                        <span class='text'>Edit data</span>
                    </a>
                    <a class='btn btn-danger btn-sm btn-icon-split' href='profil_peminjaman_password.php'>
                        <span class='icon text-white-50'>
