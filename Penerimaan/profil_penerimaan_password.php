            ...
            <div class="card bg-info mb-5 mt-3"></div>
                <div class="rounded-lg">
                    ...
                    <form method="post" action="" class="ml-2">
                        ...
                        <?php
                            ...
                            if($_SERVER['REQUEST_METHOD']=='POST'){
                                ...
                                if($ID_User=='' || $Password==''){
                                    ...
                                    if($update){
                                        echo "<script>window.location.replace('profil_penerimaan.php?pesan=edit');</script>";
                                    }else{
                                        echo "<script>window.location.replace('profil_penerimaan.php?pesan=gagal_edit');</script>";
                                    }
                                }
                            }
                        ?>
                        ...
                        <div class="mb-2">
                        <a href="profil_penerimaan.php" class="btn btn-info btn-sm btn-icon-split">
