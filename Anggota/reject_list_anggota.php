...
?>
    ...
    <div class="container-fluid p-2">
      ...
      <div class="card">
          ...
          <div class="card-header text-center">Reject List</div>

          <!-- Data Reject list buku -->
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table id='myTable' class="table table-bordered">
                ...
                WHERE ID_User='$_SESSION[ID_User]' and Status='Reject' ORDER BY ID_Pinjam DESC");
