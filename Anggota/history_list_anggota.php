...
?>
    ...
    <div class="container-fluid p-2">
      ...
      <div class="card">
          ...
          <div class="card-header text-center">History List</div>

          <!-- Data History list buku -->
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table id='myTable' class="table table-bordered">
                ...
                WHERE ID_User='$_SESSION[ID_User]' and Status='Selesai' ORDER BY ID_Pinjam DESC");
